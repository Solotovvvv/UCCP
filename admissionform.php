                ...
                <div class="details personal">
                    ...
                    <div class="input-field-1">
                        ...
                        <div class="input-field-2">
                            ...
                            <label>Email Address</label>      <span style="display: block; text-align: center;" id="emailz"></span>
    ...
    $('#LastName, #GivenName, #MiddleName, #EmailAdd').on('input', function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response == 'exists'){
                    $('#check, #emailz').html('Name and Email already exist.').css('color', 'red');
                    ...
                    $('#check').empty();
                    $('#EmailAdd').css('border-color', 'red').prop('required', true);
                    $('#emailz').html('Email already exists.').css('color', 'red');
