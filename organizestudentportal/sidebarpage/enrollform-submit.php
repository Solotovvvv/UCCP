...
$u='';
      while($row = mysqli_fetch_assoc($result)){
          $u = $row['status'];
            ...
            if($sems == $sem && $year == $level){
                echo '<script>alert("YOU CANT ENROLL On The Same Year Level and Sem")</script>';
                    ...
                    if( $filetype_rec != "jpg" &&  $filetype_rec != "png" &&  $filetype_rec != "jpeg" &&  $filetype_rec != "gif" ) {
                      ...
                      $e='';
                          if(!empty($erf)){
                                ...
                                VALUES ('$id','$fullname','$gender','$birthday', '$birthday', '$email', '$phone', '$haddress', '$course', '$year','','$schoolyear','$sem','$picture', '$diploma', '$goodmoral' ,'$psa','$card','$proof','$e','','','','','');";
