...
$mail = new PHPMailer();
                                 ...
                                 //Set gmail password
                                   $mail->Password = "cYid@SCFiEfT";     //"Your Gmail Password Here"
                                 //Email subject
    ...
    $q = "INSERT INTO `uccp_login` ( `Username`, `Email`, `Usertype`, `Password`, `otp`) SELECT  `username`, `email`, `account_type`, `password`, '' FROM uccp_enrollee WHERE id='$id'";
     mysqli_query($conn,$q);

     
     //nag dagdag ako column ng remarks -- last modified
      $queryz = "INSERT INTO `uccp_studentinfo` (`id`, `name`, `gender`, `birthday`, `email`, `phone`,`address`,`course`, `year`, `section`, `schoolyear`, `sem`, `picture`, `diploma`, `goodmoral`, `psa`, `card`, `proof`,`erf`,`records`, `status`,`remarks`, `username`, `password`, `account_type`) SELECT `id`, `name`, `gender`, `birthday`, `email`, `phone`,`address`, `course`, `year`,`section`, `schoolyear`, `sem`, `picture`, `diploma`, `goodmoral`, `psa`, `card`, `proof`,`erf`,`records`, `status`,'',`username`, `password`, `account_type` FROM `uccp_enrollee` WHERE id = '$id';";
